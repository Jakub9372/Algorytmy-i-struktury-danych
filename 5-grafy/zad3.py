...
def znajdz_optymalna_trase(
    ...
    trasa: list[str] = nx.shortest_path(G, source=magazyn, target=punkt_odbioru, weight="czas")
    ...
    laczny_czas: float = nx.shortest_path_length(G, source=magazyn, target=punkt_odbioru, weight="czas")
