...
def utworz_harmonogram(zadania: list[Zadanie]) -> list[Zadanie]:
    ...
    najblizszy_deadline = zadania[0][0]
    print("Utworzono harmonogram z " + str(liczba_zadan) + " zadaniami. Najbliższy deadline: " + str(najblizszy_deadline) + " dni.")
    return zadania
...
def najpilniejsze(harmonogram: list[Zadanie], n: int) -> list[Zadanie]:
    ...
    for zadanie in wyniki:
        ...
        nazwa = zadanie[1]
        priorytet = zadanie[2]
        print("  [" + str(dni) + "d] " + nazwa + " (" + priorytet + ")")
    return wyniki
...
def usun_najpilniejsze(harmonogram: list[Zadanie], n: int) -> list[Zadanie]:
    ...
    Intuicja: heappop() always oddaje minimum kopca, więc wywołując go n razy
    ...
    for i in range(n):
        ...
        nazwa = zadanie[1]
        priorytet = zadanie[2]
        print("  Pobrano do sprintu: [" + str(dni) + "d] " + nazwa + " (" + priorytet + ")")
...
def dodaj_zadanie(harmonogram: list[Zadanie], dni: int, nazwa: str, priorytet_biz: str) -> None:
    ...
    nowe_zadanie = (dni, nazwa, priorytet_biz)
    heapq.heappush(harmonogram, nowe_zadanie)
    print("  Dodano zadanie: '" + nazwa + "' z deadline'em za " + str(dni) + " dni.")
